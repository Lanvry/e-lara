<nav class="flex justify-between items-center py-6 mb-8 relative" aria-label="Main navigation">
    ...
    <div class="hidden lg:flex space-x-10">
        <a href="{{url('./')}}" class="text-primary font-medium hover:text-secondary transition">Beranda</a>
        <a href="{{url('./#features')}}" class="text-gray-600 font-medium hover:text-primary transition">Fitur</a>
        <a href="{{url('./#programs')}}" class="text-gray-600 font-medium hover:text-primary transition">Program</a>
        <a href="{{url('./#about')}}" class="text-gray-600 font-medium hover:text-primary transition">Tentang</a>
        <a href="{{url('./#contact')}}" class="text-gray-600 font-medium hover:text-primary transition">Kontak</a>
    </div>
